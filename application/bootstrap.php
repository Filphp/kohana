...
Route::set('estate', 'estate(/<controller>(/<action>(/<id>)))')
    ->defaults(array(
        'directory'  => 'estate',
        'controller' => 'main',
        'action'     => 'index',
...
Route::set('static', '<action>(/<id>)', array('action' => 'about|services|company|contacts|reg|login|logout'))
    ->defaults(array(
        'controller' => 'static',
    ));
